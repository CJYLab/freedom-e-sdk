...
extern char _binary_train_images_idx3_ubyte_start[];
extern char _binary_train_images_idx3_ubyte_end[];
...
int open_image ()
{
  const char *start = _binary_train_images_idx3_ubyte_start;
  const char *end   = _binary_train_images_idx3_ubyte_end;
